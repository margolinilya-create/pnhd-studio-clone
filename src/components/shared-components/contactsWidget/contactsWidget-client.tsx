...
interface ContactsWidgetClientProps {
    telegramUrl: string;
        ...
        <div className={styles.contactsWidget}>
            {isMenuOpen && (
                <ul className={styles.contactsWidget_menu}>
                    ...
                    <li className={styles.contactsWidget_menuItem}>
                        <Link href={telegramUrl} target="blank" className={styles.contactsWidget_menuItemLink}>
                    ...
                    <li className={styles.contactsWidget_menuItem}>
                        <Link href={whatsappUrl} target="blank" className={styles.contactsWidget_menuItemLink}>
                    ...
                    {maxUrl !== '' && (
                        <li className={styles.contactsWidget_menuItem}>
                            <Link href={maxUrl} target="blank" className={styles.contactsWidget_menuItemLink}>
...
export default ContactsWidgetClient;
